...
DESIGN-FIRST PROTOCOL (critical):
  ...
  Steps:
    ...
    a. Inventory docs/design/ — list every HTML/JSX/CSS/PNG/JSON file.
       Produce docs/design/COMPONENT_MAP.md (auto-generated by you)
       mapping each src/*.jsx component + futuristic variant to
       a HedgeIQ feature in PHASE_2_FEATURES_FROM_FIDELITY.md.
